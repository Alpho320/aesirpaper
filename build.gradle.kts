...
paperweight {
    upstreams.register("purpur") {
        ...
        patchFile {
            ...
            outputFile = file("aesirpaper-server/build.gradle.kts")
            patchFile = file("aesirpaper-server/build.gradle.kts.patch")
        }
        patchFile {
            path = "purpur-api/build.gradle.kts"
            outputFile = file("aesirpaper-api/build.gradle.kts")
            patchFile = file("aesirpaper-api/build.gradle.kts.patch")
        }
        patchRepo("paperApi") {
